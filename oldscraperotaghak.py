...
for page in range(1,pn+1):
    ...
    for linkdata in villa_more_info_links:
        ...
        driver.quit()
        owner = soup2.find("h3", class_="Typography_subtitle3__SUcnB text-Asphalt")
        ...
        with open(r"D:\All uni data\AP\Webscraping\All MiniProject Data\data_Otaghak.txt", "a", encoding="utf-8") as f: # You can change the directory here
